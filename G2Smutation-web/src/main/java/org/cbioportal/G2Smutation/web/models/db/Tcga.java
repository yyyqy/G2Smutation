...
public class Tcga {
    ...
    @Column(name = "REFERENCE_ALLELE1")
    private String referenceAllele1;
    
    @Column(name = "REFERENCE_ALLELE2")
    private String referenceAllele2;
    ...
    @Column(name = "NCALLERS")
    private String ncallers;
    
    @Column(name = "TCGA_VERSION")
    private String tcgaVersion;
    ...
    public String getReferenceAllele1() {
        return referenceAllele1;
    }

    public void setReferenceAllele1(String referenceAllele1) {
        this.referenceAllele1 = referenceAllele1;
    }

    public String getReferenceAllele2() {
        return referenceAllele2;
    }

    public void setReferenceAllele2(String referenceAllele2) {
        this.referenceAllele2 = referenceAllele2;
    }
    ...
    public String getDbvs() {
        return dbvs;
    }

    public void setDbvs(String dbvs) {
        this.dbvs = dbvs;
    }

    public String getNcallers() {
        return ncallers;
    }

    public void setNcallers(String ncallers) {
        this.ncallers = ncallers;
    }

    public String getTcgaVersion() {
        return tcgaVersion;
    }

    public void setTcgaVersion(String tcgaVersion) {
        this.tcgaVersion = tcgaVersion;
    }
