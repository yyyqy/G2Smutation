...
import org.cbioportal.G2Smutation.web.database.rsRepositoryInitia;
...
public class MainController {
    ...
    */
    ...
    public ModelAndView searchGetSEQRESIDUE(HttpServletRequest request,Model model){  
        ...
        String PDBRESIDUE = request.getParameter("PDBRESIDUE");
        backSEQRESIDUE=SEQRESIDUE;
        backPDBINDEX=PDBINDEX;
        backPDBRESIDUE=PDBRESIDUE;
        ...
        if (PDBINDEX.equals("") && PDBRESIDUE.equals("")) { datafind=mutationRepository.findBySeqResidueOrderByPdbIndex(SEQRESIDUE);}
        else if (PDBINDEX.equals("") && SEQRESIDUE.equals("")) { datafind=mutationRepository.findBypdbResidueOrderByPdbIndex(PDBRESIDUE);}
        else if (SEQRESIDUE.equals("") && PDBRESIDUE.equals("")) { datafind=mutationRepository.findBypdbIndex(Integer.parseInt(PDBINDEX));}
        
        else if (SEQRESIDUE.equals("")) { datafind=mutationRepository.findBypdbIndexAndPdbResidue(Integer.parseInt(PDBINDEX),PDBRESIDUE);}
        else if (PDBINDEX.equals("")) { datafind=mutationRepository.findByseqResidueAndPdbResidue(SEQRESIDUE,PDBRESIDUE);}
        else if (PDBRESIDUE.equals("")) { datafind=mutationRepository.findBypdbIndexAndSeqResidue(Integer.parseInt(PDBINDEX),SEQRESIDUE);}
        
    	else {datafind=mutationRepository.findBySeqResidueAndPdbResidueAndPdbIndex(SEQRESIDUE,PDBRESIDUE,Integer.parseInt(PDBINDEX));}
