...
public class UtilAPI {
    ...
    /**
     * GET method Call url, input chr pos, and protein seqId_index Slow if
     * calling multiple times
     * 
     * http://annotation.genomenexus.org/hgvs/17:g.79478130C%3ET?
     * isoformOverrideSource=uniprot&summary=summary
     * 
     * @param en2SeqHm
     *            <ensemblName,seqId>
     * @param gpos2proHm
    ...
    /**
     * POST method Good for bulk calling Call url, input chr pos, and protein
     * seqId_index
     * 
     * http://annotation.genomenexus.org/hgvs/17:g.79478130C%3ET?
     * isoformOverrideSource=uniprot&summary=summary
    ...
    public void callgpos2ensemblAPIPost(HashMap<String, Integer> en2SeqHm, Map gpos2proHm,
        ...
        try {
            ...
            for (QuotePro quote : quoteArray) {
                ...
                // System.out.println(quote.getVariant() + "Size:" +
                // list.size());
                for (int i = 0; i < list.size(); i++) {
                    if (list.get(i).getProtein_start() != 0) {
                        // System.out.println("((("+list.get(i));
