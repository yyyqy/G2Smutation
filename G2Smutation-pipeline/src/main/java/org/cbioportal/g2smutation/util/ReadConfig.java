...
public class ReadConfig {
	...
	public static String structureAnnoHmUpdate;
	...
	private ReadConfig() {
		...
		try {
			...
			ReadConfig.updateReleaseWeeklydownloadScript = prop.getProperty("update.release_weeklydownload_script")
					.trim();
			...
			ReadConfig.structureAnnoHmUpdate = prop.getProperty("structureAnnoHmUpdate").trim();
		} catch (Exception ex) {
	...
	public static String getStructureAnnoHmUpdate() {
		return structureAnnoHmUpdate;
	}

	public static void setStructureAnnoHmUpdate(String structureAnnoHmUpdate) {
		ReadConfig.structureAnnoHmUpdate = structureAnnoHmUpdate;
	}
