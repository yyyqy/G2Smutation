...
SELECT DISTINCT x.*,z.IDENTITY,z.IDENTP,z.EVALUE,z.BITSCORE,z.ALIGNLENGTH  FROM mutation_entry x JOIN mutation_entry y JOIN pdb_seq_alignment z ON y.MUTATION_NO = x.MUTATION_NO AND y.PDB_RESIDUE <> x.PDB_RESIDUE AND z.ALIGNMENT_ID = x.ALIGNMENT_ID ORDER BY MUTATION_NO;
