...
CREATE TABLE `structure_annotation_entry` (
  ...
  `INTERPRO_NAME` TEXT default '',
  `INTERPRO_IDENTIFIER` TEXT default '',
  ...
  `PFAM_NAME` TEXT default '',
  `PFAM_DESCRIPTION` TEXT default '',
  `PFAM_IDENTIFIER` TEXT default '',
  ...
  `CATH_ARCHITECTURE` TEXT default '',
  `CATH_CLASS` TEXT default '',
  `CATH_HOMOLOGY` TEXT default '',
  `CATH_IDENTIFIER` TEXT default '',
  `CATH_NAME` TEXT default '',
  `CATH_TOPOLOGY` TEXT default '',
  `CATH_DOMAIN_ID` TEXT default '',
  ...
  `SCOP_DESCRIPTION` TEXT default '', 
  `SCOP_IDENTIFIER` TEXT default '', 
